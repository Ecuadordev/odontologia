  ...
  function getHistoriaImprimir($id)
  {
    $paciente = $this->db->from('paciente')
      ...
      distrito.distrito_nombre as distrito,
        ...
        paciente_consulta.periodontal as periodontal,
        paciente_consulta.oclusion as oclusion,
        paciente_consulta.flourosis as flourosis,
        paciente_planes_diagnostico.enfermedades as enfermedades,
        paciente_planes_diagnostico.observaciones as observaciones,
