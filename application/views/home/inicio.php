          ...
          <div class="box box-primary collapsed-box">
               ...
               <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                    ...
                    <a  target="_blank" href="https://www.instagram.com/creativa593mkt/">
                    <img class="img-circle img-bordered-sm" src="<?= base_url() ?>assets/img/sociales/facebook.png" alt="User Image"></a>
        
                    <a target="_blank" href="https://api.whatsapp.com/send?phone=593969069691"><img class="img-circle img-bordered-sm" src="<?= base_url() ?>assets/img/sociales/whatsapp.png" alt="User Image"></a>
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="<?= base_url() ?>assets/img/adminsistemas.jpg" alt="user image">
                        <span class="username">
                          <a>Sistema Web Odontologico - DentaSoft</a>
                  ...
                  <!-- /.user-block -->
                  <p>
                    Bienvenido al sistema odontologico DentalSoft  desarrollado para clínicas y consultorios odontológicos con el objetivo de sistematizar sus procesos en registro de citas,pagos de tratamientos, historia clínica y odontograma virtual.
                  </p>
