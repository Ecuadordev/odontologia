<div id="HistoriaContenidoExploracionFisica" class="panel panel-primary" style="display: none">
  ...
  <div class="panel-body">
    <ul class="nav nav-tabs" role="tablist" style="margin-bottom: 15px">
      <li class="active" role="presentation"><a href="#enfermedad" aria-controls="enfermedad" role="tab"
          data-toggle="tab">Enfermadad actual</a></li>
      <li role="presentation"><a href="#consulta" aria-controls="consulta" role="tab" data-toggle="tab">Consulta de
          salud</a></li>
      <li role="presentation"><a href="#exploracion" aria-controls="exploracion" role="tab"
          data-toggle="tab">Exploración Física</a></li>
      <li role="presentation"><a href="#alergias" aria-controls="alergias" role="tab" data-toggle="tab">Alergias</a>
      </li>
    </ul>
    ...
    <div class="tab-content">
      <div role="tabpanel" class="tab-pane active" id="enfermedad">
        <form id="FormHistoriaMovimientoPacienteEnfermedad"
          action="<?= base_url('historia/movimiento/guardarPacienteEnfermedad') ?>" method="post">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" name="tiempoEnfermedad" class="form-control input-sm"
                  value="<?= $enfermedad->tiempo_enfact ?>">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <textarea name="motivoConsulta" class="form-control input-sm"
                  rows="3"><?= $enfermedad->motivo_enfact ?></textarea>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="control-label">Signos y sintomas principales:</label>
                <textarea name="signosSintomas" class="form-control input-sm"
                  rows="3"><?= $enfermedad->signo_enfact ?></textarea>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <textarea name="antecedentesPersonales" class="form-control input-sm"
                  rows="3"><?= $enfermedad->antecper_enfact ?></textarea>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="control-label">Antecedentes Familiares:</label>
                <textarea name="antecedentesFamiliares" class="form-control input-sm"
                  rows="3"><?= $enfermedad->antecfam_enfact ?></textarea>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="nombreMedicamento" class="form-control input-sm"
                  value="<?= $enfermedad->nommedicam_enfact ?>">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="motivoUso" class="form-control input-sm"
                  value="<?= $enfermedad->motivomedi_enfact ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
      ...
      <div role="tabpanel" class="tab-pane" id="consulta">
        <form id="FormHistoriaMovimientoPacienteConsulta"
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="form-group">
                <textarea name="hospitalizadoCirugiaTexto" class="form-control" rows="2" <?= ($consulta->hosp_paccon == '0' or $consulta->hosp_paccon == '') ? 'disabled' : '' ?>><?= $consulta->hosptexto_paccon ?></textarea>
              </div>
            </div>
          </div>
          <div class="row">
              ...
              <div class="form-group">
                ...
                <div style="display: flex; flex-wrap: wrap; padding: 10px 20px;">
                  <label class="radio-inline" style="flex: 1 1 20%;margin: 0 0 5px 0;">
                    <input type="checkbox" name="padeceEnfermedad[]" value="alergia_antibiotico"
                      <?= (in_array('alergia_antibiotico', explode(",", $consulta->padece_paccon))) ? 'checked' : '' ?>>
                    Alergia a antibióticos
                  </label>
                  <label class="radio-inline" style="flex: 1 1 20%;margin: 0 0 5px 0;">
                    <input type="checkbox" name="padeceEnfermedad[]" value="alergia_anestesia"
                      <?= (in_array('alergia_anestesia', explode(",", $consulta->padece_paccon))) ? 'checked' : '' ?>>
                    Alergia a anestesia
                  </label>
                  <label class="radio-inline" style="flex: 1 1 20%;margin: 0 0 5px 0;">
                    <input type="checkbox" name="padeceEnfermedad[]" value="hemorragias" <?= (in_array('hemorragias', explode(",", $consulta->padece_paccon))) ? 'checked' : '' ?>>
                    Hemorragias
                  </label>
                  <label class="radio-inline" style="flex: 1 1 20%;margin: 0 0 5px 0;">
                  ...
                  <label class="radio-inline" style="flex: 1 1 20%;margin: 0 0 5px 0;">
                    <input type="checkbox" name="padeceEnfermedad[]" value="tuberculosis" <?= (in_array('tuberculosis', explode(",", $consulta->padece_paccon))) ? 'checked' : '' ?>>
                    Tuberculosis
                  </label>
                  <label class="radio-inline" style="flex: 1 1 20%;margin: 0 0 5px 0;">
                  ...
                  <label class="radio-inline" style="flex: 1 1 20%;margin: 0 0 5px 0;">
                    <input type="checkbox" name="padeceEnfermedad[]" value="hipertension" <?= (in_array('hipertension', explode(",", $consulta->padece_paccon))) ? 'checked' : '' ?>>
                    Hipertensión
                  </label>
                  <label class="radio-inline" style="flex: 1 1 20%;margin: 0 0 5px 0;">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="form-group">
                <textarea name="cepillaDientesTexto" class="form-control" rows="2" <?= ($consulta->cepilla_paccon == '0' or $consulta->cepilla_paccon == '') ? 'disabled' : '' ?>><?= $consulta->cepillatexto_paccon ?></textarea>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <table style="border-collapse: collapse">
                ...
                <tr>
                  ...
                  <td rowspan="4" style="border:none;">
                    <table style="border:none; margin-left: 10px;">
                      ...
                      <tr>
                        <td class="check"> <input type="number" name="cpo[00]" value="<?= $cpo[0][0] ?>"
                            class="text-center cpo_1" onChange="calculateTotals('cpo_1', 'cpo_t_1');"
                            style="width:60px;" pattern="[0-9]{1,}" /> </td>
                        <td class="check"> <input type="number" name="cpo[01]" value="<?= $cpo[0][1] ?>"
                            class="text-center cpo_1" onChange="calculateTotals('cpo_1', 'cpo_t_1');"
                            style="width:60px;" pattern="[0-9]{1,}" /> </td>
                        <td class="check"> <input type="number" name="cpo[02]" value="<?= $cpo[0][2] ?>"
                            class="text-center cpo_1" onChange="calculateTotals('cpo_1', 'cpo_t_1');"
                            style="width:60px;" pattern="[0-9]{1,}" /> </td>
                        <td class="center vertical-center yellow check"> <input type="number" name="cpo[03]"
                            value="<?= $cpo[0][3] ?>" class="text-center cpo_t_1" style="width:60px;"
                            pattern="[0-9]{1,}" readonly /> </td>
                      </tr>
                      <tr>
                        <th class="center vertical-center green check" rowspan="2">d</th>
                        <th class="center vertical-center green check">c</th>
                      ...
                      <tr>
                        <td class="check"> <input type="number" name="cpo[10]" value="<?= $cpo[1][0] ?>"
                            class="text-center cpo_2" onChange="calculateTotals('cpo_2', 'cpo_t_2');"
                            style="width:60px;" pattern="[0-9]{1,}" /> </td>
                        <td class="check"> <input type="number" name="cpo[11]" value="<?= $cpo[1][1] ?>"
                            class="text-center cpo_2" onChange="calculateTotals('cpo_2', 'cpo_t_2');"
                            style="width:60px;" pattern="[0-9]{1,}" /> </td>
                        <td class="check"> <input type="number" name="cpo[12]" value="<?= $cpo[1][2] ?>"
                            class="text-center cpo_2" onChange="calculateTotals('cpo_2', 'cpo_t_2');"
                            style="width:60px;" pattern="[0-9]{1,}" /> </td>
                        <td class="center vertical-center yellow check"> <input type="number" name="cpo[13]"
                            value="<?= $cpo[1][3] ?>" class="text-center cpo_t_2" style="width:60px;"
                            pattern="[0-9]{1,}" readonly /> </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  ...
                  <td class="check yellow center vertical-center"><input type="radio" name="periodontal" value="leve"
                      <?= $consulta->periodontal == "leve" ? "checked" : "" ?>></td>
                  <td class="blue center vertical-center check">ANGLE I</td>
                  <td class="check yellow center vertical-center"><input type="radio" name="oclusion" value="angle"
                      <?= $consulta->oclusion == "angle" ? "checked" : "" ?>></td>
                  <td class="blue center vertical-center check">LEVE</td>
                  <td class="check yellow center vertical-center"><input type="radio" name="flourosis" value="leve"
                      <?= $consulta->flourosis == "leve" ? "checked" : "" ?>></td>
                </tr>
                <tr>
                  <td class="center vertical-center blue check">16</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="16" <?= in_array("16", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center blue check">17</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="17" <?= in_array("17", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center blue check">55</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="55" <?= in_array("55", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[11]" value="<?= $pcg[0][0] ?>"
                      class="text-center pcg_1" onChange="calculateTotals('pcg_1', 'pcg_t_1');" style="width:60px;"
                      pattern="[0,1,2,3,9]{1}" /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[12]" value="<?= $pcg[0][1] ?>"
                      class="text-center pcg_2" onChange="calculateTotals('pcg_2', 'pcg_t_2');" style="width:60px;"
                      pattern="[0,1,2,3]{1}" /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[13]" value="<?= $pcg[0][2] ?>"
                      class="text-center pcg_3" onChange="calculateTotals('pcg_3', 'pcg_t_3');" style="width:60px;"
                      pattern="[0,1]{1}" /></td>
                  <td class="blue center vertical-center check">MODERADA</td>
                  <td class="check yellow center vertical-center"><input type="radio" name="periodontal"
                      value="moderada" <?= $consulta->periodontal == "moderada" ? "checked" : "" ?>></td>
                  <td class="blue center vertical-center check">ANGLE II</td>
                  <td class="check yellow center vertical-center"><input type="radio" name="oclusion" value="angle2"
                      <?= $consulta->oclusion == "angle2" ? "checked" : "" ?>></td>
                  <td class="blue center vertical-center check">MODERADA</td>
                  <td class="check yellow center vertical-center"><input type="radio" name="flourosis" value="moderada"
                      <?= $consulta->flourosis == "moderada" ? "checked" : "" ?>></td>
                </tr>
                <tr>
                  <td class="center vertical-center blue check">11</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="11" <?= in_array("11", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center blue check">21</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="21" <?= in_array("21", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center blue check">51</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="51" <?= in_array("51", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[21]" value="<?= $pcg[1][0] ?>"
                      class="text-center pcg_1" onChange="calculateTotals('pcg_1', 'pcg_t_1');" style="width:60px;"
                      pattern="[0,1,2,3,9]{1}" /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[22]" value="<?= $pcg[1][1] ?>"
                      class="text-center pcg_2" onChange="calculateTotals('pcg_2', 'pcg_t_2');" style="width:60px;"
                      pattern="[0,1,2,3]{1}" /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[23]" value="<?= $pcg[1][2] ?>"
                      class="text-center pcg_3" onChange="calculateTotals('pcg_3', 'pcg_t_3');" style="width:60px;"
                      pattern="[0,1]{1}" /></td>
                  <td class="blue center vertical-center check">SEVERA</td>
                  <td class="check yellow center vertical-center"><input type="radio" name="periodontal" value="severa"
                      <?= $consulta->periodontal == "severa" ? "checked" : "" ?>></td>
                  <td class="blue center vertical-center check">ANGLE III</td>
                  <td class="check yellow center vertical-center"><input type="radio" name="oclusion" value="angle3"
                      <?= $consulta->oclusion == "angle3" ? "checked" : "" ?>></td>
                  <td class="blue center vertical-center check">SEVERA</td>
                  <td class="check yellow center vertical-center"><input type="radio" name="flourosis" value="severa"
                      <?= $consulta->flourosis == "severa" ? "checked" : "" ?>></td>
                </tr>
                <tr>
                  <td class="center vertical-center blue check">26</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="26" <?= in_array("26", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center blue check">27</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="27" <?= in_array("27", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center blue check">65</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="65" <?= in_array("65", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[31]" value="<?= $pcg[2][0] ?>"
                      class="text-center pcg_1" onChange="calculateTotals('pcg_1', 'pcg_t_1');" style="width:60px;"
                      pattern="[0,1,2,3,9]{1}" /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[32]" value="<?= $pcg[2][1] ?>"
                      class="text-center pcg_2" onChange="calculateTotals('pcg_2', 'pcg_t_2');" style="width:60px;"
                      pattern="[0,1,2,3]{1}" /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[33]" value="<?= $pcg[2][2] ?>"
                      class="text-center pcg_3" onChange="calculateTotals('pcg_3', 'pcg_t_3');" style="width:60px;"
                      pattern="[0,1]{1}" /></td>
                ...
                <tr>
                  ...
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="36" <?= in_array("36", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center blue check">37</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="37" <?= in_array("37", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center blue check">75</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="75" <?= in_array("75", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[41]" value="<?= $pcg[3][0] ?>"
                      class="text-center pcg_1" onChange="calculateTotals('pcg_1', 'pcg_t_1');" style="width:60px;"
                      pattern="[0,1,2,3,9]{1}" /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[42]" value="<?= $pcg[3][1] ?>"
                      class="text-center pcg_2" onChange="calculateTotals('pcg_2', 'pcg_t_2');" style="width:60px;"
                      pattern="[0,1,2,3]{1}" /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[43]" value="<?= $pcg[3][2] ?>"
                      class="text-center pcg_3" onChange="calculateTotals('pcg_3', 'pcg_t_3');" style="width:60px;"
                      pattern="[0,1]{1}" /></td>
                </tr>
                <tr>
                  ...
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="31" <?= in_array("31", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center blue check">41</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="41" <?= in_array("41", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center blue check">71</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="71" <?= in_array("71", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[51]" value="<?= $pcg[4][0] ?>"
                      class="text-center pcg_1" onChange="calculateTotals('pcg_1', 'pcg_t_1');" style="width:60px;"
                      pattern="[0,1,2,3,9]{1}" /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[52]" value="<?= $pcg[4][1] ?>"
                      class="text-center pcg_2" onChange="calculateTotals('pcg_2', 'pcg_t_2');" style="width:60px;"
                      pattern="[0,1,2,3]{1}" /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[53]" value="<?= $pcg[4][2] ?>"
                      class="text-center pcg_3" onChange="calculateTotals('pcg_3', 'pcg_t_3');" style="width:60px;"
                      pattern="[0,1]{1}" /></td>
                </tr>
                <tr>
                  ...
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="46" <?= in_array("46", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center blue check">47</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="47" <?= in_array("47", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center blue check">85</td>
                  <td class="center vertical-center check yellow"><input type="checkbox" name="health_piece[]"
                      value="85" <?= in_array("85", explode(",", $consulta->health_piece)) ? "checked" : "" ?> /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[61]" value="<?= $pcg[5][0] ?>"
                      class="text-center pcg_1" onChange="calculateTotals('pcg_1', 'pcg_t_1');" style="width:60px;"
                      pattern="[0,1,2,3,9]{1}" /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[62]" value="<?= $pcg[5][1] ?>"
                      class="text-center pcg_2" onChange="calculateTotals('pcg_2', 'pcg_t_2');" style="width:60px;"
                      pattern="[0,1,2,3]{1}" /></td>
                  <td class="center vertical-center check"><input type="number" name="pcg[63]" value="<?= $pcg[5][2] ?>"
                      class="text-center pcg_3" onChange="calculateTotals('pcg_3', 'pcg_t_3');" style="width:60px;"
                      pattern="[0,1]{1}" /></td>
                </tr>
                <tr>
                  <td colspan="6" class="green center vertical-center">Totales</td>
                  <td class="center vertical-center yellow"><input type="number" name="pcg[71]"
                      value="<?= $pcg[6][0] ?>" class="text-center pcg_t_1" style="width:60px;" readonly /></td>
                  <td class="center vertical-center yellow"><input type="number" name="pcg[72]"
                      value="<?= $pcg[6][1] ?>" class="text-center pcg_t_2" style="width:60px;" readonly /></td>
                  <td class="center vertical-center yellow"><input type="number" name="pcg[73]"
                      value="<?= $pcg[6][2] ?>" class="text-center pcg_t_3" style="width:60px;" readonly /></td>
                </tr>
              </table>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <textarea name="odontoestomatologico" class="form-control input-sm"
                  rows="3"><?= $exploracion->odontoesto_exp ?></textarea>
              </div>
            </div>
          </div>
      ...
      <div role="tabpanel" class="tab-pane" id="alergias">
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#ModalAgregarAlergia"><i
...
<div id="ModalAgregarAlergia" class="modal fade" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content ">
      <form id="FormHistoriaMovimientoAgregarAlergia" action="<?= base_url('historia/movimiento/agregarAlergia') ?>"
