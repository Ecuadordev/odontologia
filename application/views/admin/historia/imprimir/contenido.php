  ...
  <table style="border-collapse: collapse">
    ...
    <tr>
      ...
      <td class="center vertical-center check yellow"><?= in_array("16", explode(",",$historia->health_piece)) ? "X" : ""?></td>
      <td class="center vertical-center blue">17</td>
      <td class="center vertical-center check yellow"><?= in_array("17", explode(",",$historia->health_piece)) ? "X" : ""?></td>
      <td class="center vertical-center blue">55</td>
      <td class="center vertical-center check yellow"><?= in_array("55", explode(",",$historia->health_piece)) ? "X" : ""?></td>
    ...
    <tr>
      ...
      <td class="center vertical-center check yellow"><?= in_array("11", explode(",",$historia->health_piece)) ? "X" : ""?></td>
      <td class="center vertical-center blue">21</td>
      <td class="center vertical-center check yellow"><?= in_array("21", explode(",",$historia->health_piece)) ? "X" : ""?></td>
      <td class="center vertical-center blue">51</td>
      <td class="center vertical-center check yellow"><?= in_array("51", explode(",",$historia->health_piece)) ? "X" : ""?></td>
    ...
    <tr>
      ...
      <td class="center vertical-center check yellow"><?= in_array("26", explode(",",$historia->health_piece)) ? "X" : ""?></td>
      <td class="center vertical-center blue">27</td>
      <td class="center vertical-center check yellow"><?= in_array("27", explode(",",$historia->health_piece)) ? "X" : ""?></td>
      <td class="center vertical-center blue">65</td>
      <td class="center vertical-center check yellow"><?= in_array("65", explode(",",$historia->health_piece)) ? "X" : ""?></td>
    ...
    <tr>
      ...
      <td class="center vertical-center check yellow"><?= in_array("36", explode(",",$historia->health_piece)) ? "X" : ""?></td>
      <td class="center vertical-center blue">37</td>
      <td class="center vertical-center check yellow"><?= in_array("37", explode(",",$historia->health_piece)) ? "X" : ""?></td>
      <td class="center vertical-center blue">75</td>
      <td class="center vertical-center check yellow"><?= in_array("75", explode(",",$historia->health_piece)) ? "X" : ""?></td>
    ...
    <tr>
      ...
      <td class="center vertical-center check yellow"><?= in_array("31", explode(",",$historia->health_piece)) ? "X" : ""?></td>
      <td class="center vertical-center blue">41</td>
      <td class="center vertical-center check yellow"><?= in_array("41", explode(",",$historia->health_piece)) ? "X" : ""?></td>
      <td class="center vertical-center blue">71</td>
      <td class="center vertical-center check yellow"><?= in_array("71", explode(",",$historia->health_piece)) ? "X" : ""?></td>
    ...
    <tr>
      ...
      <td class="center vertical-center check yellow"><?= in_array("46", explode(",",$historia->health_piece)) ? "X" : ""?></td>
      <td class="center vertical-center blue">47</td>
      <td class="center vertical-center check yellow"><?= in_array("47", explode(",",$historia->health_piece)) ? "X" : ""?></td>
      <td class="center vertical-center blue">85</td>
      <td class="center vertical-center check yellow"><?= in_array("85", explode(",",$historia->health_piece)) ? "X" : ""?></td>
