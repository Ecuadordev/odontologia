...
<div class="row">
	<div class="col-md-4">
		<div class="form-group">
			<label>Registro SENECYT: *</label>
			<input type="text" name="colegiatura" class="form-control input-sm" placeholder="Registro SENECYT" value="<?php echo isset($medicos) ? $medicos->coleg_med : ''; ?>" maxlength="9" minlength="4" onkeypress="if (event.keyCode < 48 || event.keyCode > 57) return false;">
		</div>
	</div>
	<div class="col-md-4">
		<div class="form-group">
